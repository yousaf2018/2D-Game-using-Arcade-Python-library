...
class Game(arcade.View):
    ...
    def on_draw(self):
        ...
        if self.state == "GameMenu":
            ...
            arcade.draw_text(" Player2 | Player1 ", 800, 300, arcade.color.BRIGHT_GREEN, font_size=20, anchor_x="center")
            arcade.draw_text(" Player2 | Player1 ", 801, 300, arcade.color.BRIGHT_GREEN, font_size=20, anchor_x="center")
            arcade.draw_text(" Player2 | Player1 ", 801, 300, arcade.color.BRIGHT_GREEN, font_size=20, anchor_x="center")
